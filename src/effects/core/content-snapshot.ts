...
export class ContentSnapshot extends Phaser.Image {
     ...
     * @extend Phaser.Image
     */
    constructor(game: Phaser.Game, x: number, y: number, noStage: boolean) {
        const texture = new Phaser.RenderTexture(game, game.width, game.height, "", Phaser.scaleModes.DEFAULT, game.renderer.resolution);
